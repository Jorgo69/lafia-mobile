<x-mobile-page :title="__('vault.title')">
    ...
    <x-slot:actions>
        @if (!$isLocked)
            <button wire:click="lock" class="text-xs text-red-500 font-medium flex items-center gap-1 press-feedback">
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <x-card class="space-y-4">
                        <div>
                            ...
                            <select wire:model="bloodType" class="w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm py-3">
                                <option value="">—</option>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="number" wire:model="weightKg" step="0.1" class="w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm py-3" placeholder="72.5">
                            </div>
                            <div>
                                <label class="block text-sm font-medium mb-1">{{ __('vault.height') }}</label>
                                <input type="number" wire:model="heightCm" step="0.1" class="w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm py-3" placeholder="175">
                            </div>
                        </div>
                    </x-card>
                    ...
                    <x-card>
                        ...
                        <textarea wire:model="emergencyNotes" rows="3" class="w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm py-3 px-4"></textarea>
                    </x-card>
                    ...
                    <p class="text-[11px] text-center text-gray-400">{{ __('vault.encrypted_info') }}</p>
                </form>
            ...
            @elseif ($decryptedData)
                <x-card class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <button wire:click="edit" class="text-sm text-blue-500 font-medium flex items-center gap-1 press-feedback">
